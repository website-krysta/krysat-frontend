                                          ...
                                          <div class="row">
                                              ...
                                              <div className="col-md-6" id="vendorform" >
                                                  ...
                                                  <label>Damaged Qty</label>
                                                      <input type="number" name="DamagedQty" value={productItem.OrderedQuantity-productItem.ReceivedQuantity}  onChange={handleDamagedChange} className="form-control pt-3" id="code" placeholder="Damaged Qty" required />
                                                  </div>
                                                  <div className="mb-3">
